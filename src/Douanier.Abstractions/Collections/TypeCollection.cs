...
namespace Douanier.Abstractions.Collections
{
    ...
    /// </summary>
    public class TypeCollection : TypeCollection<object>, ITypeCollection
    {
    }

    /// <summary>
    /// Extends <see cref="Collection{Type}"/> to add restriction a specific base type.
    /// </summary>
    /// <typeparam name="TBaseType">Base Type of <see cref="Type"/>s in this list</typeparam>
    public class TypeCollection<TBaseType> : ITypeCollection<TBaseType>
    {
        private readonly Collection<Type> _typeList;

        /// <summary>
        /// Creates a new <see cref="TypeCollection{T}"/> object.
        /// </summary>
        public TypeCollection()
        {
            _typeList = new Collection<Type>();
        }
